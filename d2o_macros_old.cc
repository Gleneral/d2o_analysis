  ...
  //cout << "euler = " << euler << "; atten = " << atten << endl; //debug line
    ...
    while(biasp < 1.001)
     ...
     //how GPS picks values from histogram:
      ...
      k00 = -0.25/pi*(cos(t2) - cos(t1))*(p2-p1);
      k01 = -0.125/pi*(cos(t2)*cos(t2) - cos(t1)*cos(t1) + 2.*cos(t2) - 2.*cos(t1))*(p2-p1); 
      k02 = -0.125/pi*((cos(t2) - cos(t1))*(p2 - p1) + (pow(cos(t2),3) - pow(cos (t1),3))*(p2 - p1));
      k03 = -0.125/pi*(2.*(cos(t2) - cos(t1)) + 1.25*(pow(cos(t2),4) - pow(cos(t1),4)) - 1.5*(cos(t2)*cos(t2) - cos(t1)*cos(t1)))*(p2 - p1);
      k04 = -0.03125/pi*(11.*(cos(t2) - cos(t1)) + 7*(pow(cos(t2),5) - pow(cos(t1),5)) - 10*(pow(cos(t2),3) - pow(cos(t1),3)))*(p2 - p1);
      k22 = -(0.0833333333/pi)*(3*(cos(t2) - cos(t1))*(p2 - p1 + 0.5*sin(2*p2) - 0.5*sin(2*p1)) - 0.5*(pow(cos(t2),3) - pow(cos(t1),3))*(sin(2*p2) - sin(2*p1)));
      k23 = -(0.04166666667/pi)*(6*(cos(t2)-cos(t1))*(p2 - p1) + 15*(0.5*pow(cos(t2),2) - 0.5*pow(cos(t1),2) - 0.25*pow(cos(t2),4) + 0.25*pow(cos(t1),4))*0.5*(sin(2*p2) - sin(2*p1)));
      k24 = -(0.025/pi)*(10.*(cos(t2)-cos(t1))*(p2 - p1) + 7.5*(2.66666667*(pow(cos(t2),3) - pow(cos(t1),3)) - (cos(t2) - cos(t1)) - 1.4*(pow(cos(t2),5) - pow(cos(t1),5)))*0.5*(sin(2*p2) - sin(2*p1)));
      k11 = 0.25/pi*(-1*(cos(t2) - cos(t1))*(p2 - p1) + (0.5*t2 - 0.5*t1 - 0.25*sin(2*t2) + 0.25*sin(2*t1))*(sin(p2) - sin(p1)));
      k12 = 0.0833333333/pi*(2.*(pow(sin(t2),3) - pow(sin(t1),3))*(sin(p2) - sin(p1)) - 3*(cos(t2) - cos(t1))*(p2 - p1));
      k110 = 0.25/pi*(-1*(cos(t2) - cos(t1))*(p2 - p1) - (0.5*t2 - 0.5*t1 - 0.25*sin(2*t2) + 0.25*sin(2*t1))*(cos(p2) - cos(p1))); //this corresponds to k = 11 '
      k120 = 0.0833333333/pi*(-1.0*2.*(pow(sin(t2),3) - pow(sin(t1),3))*(cos(p2) - cos(p1)) - 3*(cos(t2) - cos(t1))*(p2 - p1)); //this corresponds to k = 12 '
